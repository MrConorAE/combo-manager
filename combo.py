...
help = {
    ...
    "How to use Combo Manager": "Combo Manager is a program for creating, updating, deleting and managing combos (combination deals, which allow you to purchase a a set of items for a fixed price, usually less than they would be individually), which are usually found businesses such as cafes and restaurants.\n\nThis program allows you to do this through a set of windows, in which you select items, type data, click buttons, etc. to perform actions.\n\nFor help on a specific action, click [Back] at the bottom of this window and choose the item that best represents what you want to do.",
